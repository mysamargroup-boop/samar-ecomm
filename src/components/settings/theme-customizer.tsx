...
export function ThemeCustomizer() {
  ...
  return (
    <form className="space-y-8">
      ...
      <div className="flex justify-end fixed bottom-0 left-0 right-0 md:relative bg-background/80 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none border-t md:border-none p-4 md:p-0 z-50">
